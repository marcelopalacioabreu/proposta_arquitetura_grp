...
namespace Retaguarda.Api.Controllers
{
    ...
    public class EnderecoController : BaseController
    {
        ...
        [HttpGet]
        [Authorize(Policy = "enderecos.visualizar")]
        ...
        [HttpPost]
        [Authorize(Policy = "enderecos.editar")]
        public IActionResult Create([FromBody] EnderecoDto dto)
        {
        ...
        [HttpDelete("{id}")]
        [Authorize(Policy = "enderecos.excluir")]
        ...
        [HttpPut("{id}")]
        [Authorize(Policy = "enderecos.editar")]
        public IActionResult Update(long id, [FromBody] EnderecoDto dto)
        {
            if (!ModelState.IsValid) return BadRequestModelState();
