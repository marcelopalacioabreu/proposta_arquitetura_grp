...
namespace Retaguarda.Api.Controllers
{
    ...
    public class BairroController : BaseController
    {
        ...
        [HttpGet]
        [Authorize(Policy = "enderecos.bairros.visualizar")]
        ...
        [HttpPost]
        [Authorize(Policy = "enderecos.bairros.editar")]
        public IActionResult Create([FromBody] EnderecoBairroDto dto)
        {
        ...
        [HttpDelete("{id}")]
        [Authorize(Policy = "enderecos.bairros.excluir")]
        ...
        [HttpPut("{id}")]
        [Authorize(Policy = "enderecos.bairros.editar")]
        public IActionResult Update(long id, [FromBody] EnderecoBairroDto dto)
        {
            if (!ModelState.IsValid) return BadRequestModelState();
