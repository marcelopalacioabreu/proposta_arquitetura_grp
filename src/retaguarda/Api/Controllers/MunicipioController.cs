...
namespace Retaguarda.Api.Controllers
{
    ...
    {
        private readonly IMunicipioServico _servico;

        public MunicipioController(IMunicipioServico servico)
        {
            _servico = servico;
        }

        [HttpGet]
        [Authorize(Policy = "enderecos.municipios.visualizar")]
        ...
        [HttpPost]
        [Authorize(Policy = "enderecos.municipios.editar")]
        public IActionResult Create([FromBody] EnderecoMunicipioDto dto)
        {
        ...
        [HttpDelete("{id}")]
        [Authorize(Policy = "enderecos.municipios.excluir")]
        ...
        [HttpPut("{id}")]
        [Authorize(Policy = "enderecos.municipios.editar")]
        public IActionResult Update(long id, [FromBody] EnderecoMunicipioDto dto)
        {
            if (!ModelState.IsValid) return BadRequestModelState();
