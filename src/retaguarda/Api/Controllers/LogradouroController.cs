...
namespace Retaguarda.Api.Controllers
{
    ...
    {
        private readonly ILogradouroServico _servico;

        public LogradouroController(ILogradouroServico servico)
        {
            _servico = servico;
        }

        [HttpGet]
        [Authorize(Policy = "logradouros.visualizar")]
        ...
        [HttpPost]
        [Authorize(Policy = "logradouros.editar")]
        ...
        [HttpDelete("{id}")]
        [Authorize(Policy = "logradouros.excluir")]
