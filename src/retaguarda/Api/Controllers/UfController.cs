...
namespace Retaguarda.Api.Controllers
{
    ...
    {
        private readonly IUfServico _servico;

        public UfController(IUfServico servico)
        {
            _servico = servico;
        }

        [HttpGet]
        [Authorize(Policy = "enderecos.ufs.visualizar")]
        ...
        [HttpPost]
        [Authorize(Policy = "enderecos.ufs.editar")]
        public IActionResult Create([FromBody] EnderecoUFDto dto)
        {
        ...
        [HttpDelete("{id}")]
        [Authorize(Policy = "enderecos.ufs.excluir")]
        ...
        [HttpPut("{id}")]
        [Authorize(Policy = "enderecos.ufs.editar")]
        public IActionResult Update(long id, [FromBody] EnderecoUFDto dto)
        {
            if (!ModelState.IsValid) return BadRequestModelState();
